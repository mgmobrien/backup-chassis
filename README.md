...
- macOS: `clang`, `codesign`, `launchctl`, `plutil`; SwiftBar is optional if you want the menubar surface
...
- `bin/system3-backup`
- `bin/system3-backup-backup`
- `bin/system3-backup-build-macos-runner`
...
- `src/macos/backup-chassis-runner.c`
...
config surface, a signed dedicated runner app, launchd plist, and SwiftBar
